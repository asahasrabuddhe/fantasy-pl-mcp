...
async def get_fixtures_resource(gameweek_id: int | None = None, team_name: str | None = None) -> list[dict[str, Any]]:
    ...
    for fixture in fixtures:
        ...
        formatted_fixture = {
            ...
            "difficulty": {"home": fixture.get("team_h_difficulty", 0), "away": fixture.get("team_a_difficulty", 0)},
...
async def get_blank_gameweeks(num_gameweeks: int = 5) -> list[dict[str, Any]]:
    ...
    upcoming_gameweeks = [
        gw for gw in all_gameweeks if gw["id"] >= current_gw_id and gw["id"] < current_gw_id + num_gameweeks
    ]
